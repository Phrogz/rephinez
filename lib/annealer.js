module.exports = function ({
    ...
    return {bestState:status.bestState, bestScore:status.bestScore, elapsed, variations:status.totalVariations, rounds:status.roundNumber, roundProgress:1, totalProgress:1};
